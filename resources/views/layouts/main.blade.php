...
<head>
    ...
    <link rel="icon" sizes="128x128" href="{!! asset('img/enera_logo_app.png') !!}">
    <link rel="apple-touch-icon" sizes="128x128" href="{!! asset('img/enera_logo_app.png') !!}">
    <link rel="apple-touch-icon-precomposed" sizes="128x128" href="{!! asset('img/enera_logo_app.png') !!}">
    @yield('head_scripts')
</head>
