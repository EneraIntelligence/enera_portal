...
@section('header')
    ...
    <nav>
        <div class="nav-wrapper z-depth-3 blue darken-4">

            <p class="center-align welcome-text">Bienvenido a {!! $network_name !!}</p>
            <p class="center-align">Wi-Fi gratis</p>
...
@section('content')
    ...
    <div class="ads-container">
        <div id="ads-card" class="portal-img z-depth-2">
            <img class="responsive-img"
                 src="http://s3-us-west-1.amazonaws.com/enera-publishers/items/1471627137.jpg">
        </div>
    ...
    <div class="final-message">
        <p class="center-align">Redirigiendo...</p>
        <p class="center-align">Internet gratis por </p>

        <img src="{!! asset("img/30mins.png") !!}" alt="">
    </div>
    ...
    <div class="footer-copyright white">
        <div class="container">
            ...
            <div class="steps">
                ...
                <div class="progress-line grey white-text">
                    <div class="inner blue" id="progress-bar"></div>
                </div>

                <div class="step step-1">
                    <div class="circle white-text"><p>1</p></div>
                    <p class="blue-text">Acepta</p>
                </div>
                <div class="step step-2">
                    <div id="step-2" class="circle white-text"><p>2</p></div>
                    <p id="step-2-text">Interactúa</p>
                </div>
                <div class="step step-3">
                    <div id="step-3" class="circle white-text"><p>3</p></div>
                    <p id="step-3-text">Internet</p>
                </div>
            </div>
