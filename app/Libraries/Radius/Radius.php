...
class Radius
{
    ...
    public function auth($user, $pass)
    {
        ...
        radius_put_vendor_str($this->radius,RADIUS_CALLING_STATION_ID, "DC-9B-9C-4A-B6-C1");
        radius_put_vendor_str($this->radius,RADIUS_CALLED_STATION_ID, "6C-AA-B3-2D-A8-98:WIFI_RUCKUS");
